  ...
  <el-dialog title="修改资料" :close-on-click-modal="false"
    ...
    <el-form :model="dialog.dataForm" ref="dialogForm"
      ...
      <el-form-item label="姓名" prop="name">
        <el-input v-model="dialog.dataForm.name" placeholder="输入姓名"
                  maxlength="10" size="medium" class="input" clearable />
      </el-form-item>
      <el-form-item label="性别" prop="sex" style="width: 93%">
        <el-select v-model="dialog.dataForm.sex" placeholder="选择性别"
      ...
      <el-form-item label="电话" prop="tel">
        <el-input v-model="dialog.dataForm.tel" placeholder="输入电话"
