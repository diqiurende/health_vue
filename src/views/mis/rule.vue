...
<template>
  <div v-if="proxy.isAuth(['ROOT', 'RULE:SELECT'])">
    <el-form :inline="true" :model="dataForm" :rules="dataRule" ref="form">
      <el-form-item prop="name">
        <el-input v-model="dataForm.name" placeholder="规则名称"
  ...
  <el-table :data="data.dataList"
    ...
    <el-table-column prop="name" header-align="left" align="left"
  ...
  <el-dialog :title="!dialog.dataForm.id ? '新增' : '修改'"
    ...
    <el-form :model="dialog.dataForm" ref="dialogForm"
      ...
      <el-form-item label="规则名称" prop="name">
        <el-input v-model="dialog.dataForm.name" maxlength="20"
                  clearable />
      </el-form-item>
      <el-form-item label="规则内容" prop="rule">
        <el-input v-model="dialog.dataForm.rule" type="textarea"
                  rows="5" clearable />
      </el-form-item>
      <el-form-item label="备注信息">
        <el-input v-model="dialog.dataForm.remark" type="textarea"
                  rows="3" clearable />
      </el-form-item>
    </el-form>
