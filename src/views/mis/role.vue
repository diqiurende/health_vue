...
function dataFormSubmit() {
  proxy.$refs['dialogForm'].validate(valid => {
    if (valid) {
      ...
      //分别把两个数组的元素拼接成字符串，比较字符串的内容就知道数组内容是否相同
...
<template>
  ...
  <el-table :data="data.dataList"
    ...
    <el-table-column prop="roleName" header-align="center"
                     align="center" label="角色名称" min-width="180" />
  ...
  <el-dialog :title="!dialog.dataForm.id ? '新增' : '修改'"
             ...
             custom-class="dialog" width="692px">
