        ...
        <div class="content-container">
              ...
              <el-row :gutter="16">
                <el-col :span="6">
                  <div class="statistic-card">
                    <el-statistic :value="scope.row.number-scope.row.num"
                                  suffix="个">
                      <template #title>
                ...
                <el-col :span="6">
                  <div class="statistic-card">
                    <el-statistic :value="scope.row.number"
                                  suffix="个">
                      <template #title>
          ...
          <div class="right-panel">
            <el-table :data="data.appointment"
              ...
              <el-table-column prop="name" label="体检人" label-align="center"
                               align="center" min-width="180" />
              <el-table-column prop="sex" label="性别" label-align="center"
                               align="center" min-width="120" />
              <el-table-column prop="age" label="年龄" label-align="center"
                               align="center" min-width="120" />
              <el-table-column prop="tel" label="电话" label-align="center"
                               align="center" min-width="180" />
              <el-table-column prop="date" label="体检日" label-align="center"
                               align="center" min-width="180" />
